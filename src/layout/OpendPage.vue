...
div(class="relative w-4/6 h-full flex flex-col items-center justify-start py-5 mx-5")
	...
	//- Tiptap ToolsBar
	div(class="w-full p-2 pt-0 rounded-lg mb-2 flex flex-row flex-wrap gap-2 [&>button]:flex [&>button]:items-center [&>button]:justify-center [&>button]:w-6 [&>button]:h-6 [&>button]:bg-[var(--dark100)] [&>button]:rounded-md [&>button>svg]:w-5 [&>button>svg]:fill-white " v-if="editor")
