...
header(class="border-[var(--dark200)] border-b w-full flex items-center p-2 select-none h-[var(--HeaderHeight)] bg-[var(--dark300)]" style="-webkit-app-region: drag;")
	...
	//- Dark / Light Button
	div(class="toggleMode" style="-webkit-app-region: no-drag")
...
.toggleMode {
	@apply h-8 w-16 mx-3 flex flex-col items-center justify-center;
	...
	label {
		...
		&:after {
			content: "";
			@apply w-7 h-7 absolute top-6 left-6 rounded-full duration-300;
