...
header(class="w-full p-2 h-[var(--HeaderHeight)] flex items-center select-none border-[var(--dark200)] border-b bg-white dark:bg-[var(--dark300)]" style="-webkit-app-region: drag;")
	...
	div(class="h-7 flex items-center justify-center" style="-webkit-app-region: no-drag")
		...
		div(class="mx-2 h-8 w-8 rounded-full border-2 border-solid bg-[var(--dark100)] border-[var(--favColor)]" id="avatar")
			<svg class="w-8 fill-black dark:fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C17.52 2 22 6.48 22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2ZM6.02332 15.4163C7.49083 17.6069 9.69511 19 12.1597 19C14.6243 19 16.8286 17.6069 18.2961 15.4163C16.6885 13.9172 14.5312 13 12.1597 13C9.78821 13 7.63095 13.9172 6.02332 15.4163ZM12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z"/></svg>
