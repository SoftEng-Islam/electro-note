...
div(v-show="true" class="z-50 flex flex-col items-center justify-center fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-72 p-3 rounded-3xl shadow-lg" style="background: var(--bgG)")
	...
	div(class="w-full flex flex-col items-center justify-center")
		button(type="button" @click="console.log(`user avatar`)" class="hover:opacity-50 relative w-24 h-24 p-2 border-2 border-white backdrop-blur flex items-center justify-center rounded-full shadow-xl")
			<svg v-show="!isAvatar" class="w-full fill-black dark:fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C17.52 2 22 6.48 22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2ZM6.02332 15.4163C7.49083 17.6069 9.69511 19 12.1597 19C14.6243 19 16.8286 17.6069 18.2961 15.4163C16.6885 13.9172 14.5312 13 12.1597 13C9.78821 13 7.63095 13.9172 6.02332 15.4163ZM12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z"/></svg>
			<svg v-show="!isAvatar" class="w-5 h-5 p-1 absolute right-1 bottom-1 fill-black bg-white rounded-full shadow-lg" viewBox="0 0 32 32" ><path d="M28,14H18V4c0-1.104-0.896-2-2-2s-2,0.896-2,2v10H4c-1.104,0-2,0.896-2,2s0.896,2,2,2h10v10c0,1.104,0.896,2,2,2  s2-0.896,2-2V18h10c1.104,0,2-0.896,2-2S29.104,14,28,14z"/></svg>
			input(type="file" accept="image/jpeg" @change="console.log('avatar')" class="z-10 w-full h-full invisible absolute left-0 top-0")
