...
div(class="z-50 flex flex-col items-center justify-center fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-72 p-3 rounded-3xl dark:bg-[var(--dark400)] border-1 shadow-lg")
	//- Avatar
